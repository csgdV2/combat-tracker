...
public class HudRenderer {
    ...
    private static final int RECORDING_PADDING = 4;
    ...
    public static void render(GuiGraphics graphics) {
        ...
        if (config.hudLayout == 2 && !SessionRecorder.get().isPlayerRecording()) {
            return;
        }
        int w = scaledWidth();
        int h = scaledHeight();
    ...
    private static int padding() {
        return CtConfig.get().hudLayout == 2 ? RECORDING_PADDING : PADDING;
    }
